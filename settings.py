...
redshoot = font.render('슛 세기  1~10',0,(255,255,255))
redpass = font.render('패스 세기  1~10',0,(255,255,255))
bluerunspeed = font.render('속력  1~10',0,(255,255,255))
redrunspeed = font.render('속력  1~10',0,(255,255,255))
save = font.render('설정 저장하기',0,(255,255,255))
reset = font.render('설정 초기화',0,(255,255,255))
title = font.render('설 정',0,(255,255,255))
class InputBox:
...
def main(width,height):
    ...
    while running:
        ...
        screen.blit(reset,[108,500])
        screen.blit(save,[778,500])
        screen.blit(title,[476,50])
        pygame.display.flip()
        clock.tick(30)
